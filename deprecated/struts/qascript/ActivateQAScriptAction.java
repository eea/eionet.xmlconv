...
public class ActivateQAScriptAction extends Action {
    private static final Logger LOGGER = LoggerFactory.getLogger(ActivateQAScriptAction.class);
    ...
    public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
        ...
        try {
            ...
            messages.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage("label.qascript.activated"));
