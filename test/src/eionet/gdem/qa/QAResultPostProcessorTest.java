...
public class QAResultPostProcessorTest extends DBTestCase {
    ...
    public void testExpiredSchemaQAResult() {
        ...
        String message = postProcessor
                .getWarningMessage("http://localhost/not_existing.xsd");

        assertTrue(message.indexOf("expired") > -1);

        String message2 = postProcessor
                .getWarningMessage("http://localhost/not_existing2.xsd");
        assertNull(message2);
    }
