...
public class SchemaManagerTest extends TestCase {
	...
	/**
	 * Test getDDSchemas method. The result should be ordered list of Schema objects.
	 * The schemas are ordered by table names, dataset names and dateRelased descending.
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * Test getSchemas(String user_name, String type) method. The result should be ordered list of Schema objects.
	 * The schemas are ordered by table names, dataset names and dateRelased descending.
	 * 
	 * @throws Exception
	 */
