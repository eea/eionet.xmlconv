...
public class QAScriptManagerTest  extends DBTestCase{
	...
	/**
	 * The method adds QA Script into DB, then it edits the properties and finally deletes the added schema.
	...
	public void testUpdateQAScriptFile() throws Exception{
		...
		MockFormFile scriptFile = new MockFormFile(getClass().getClassLoader().getResource(TestConstants.SEED_QASCRIPT_XQUERY2)
				.getFile());
