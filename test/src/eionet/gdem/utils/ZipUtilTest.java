...
public class ZipUtilTest extends TestCase {
	...
	/**
	 * Test ZipUtil unzip method.
	 * Exctract the seed...zip file into tmp directory and check that the unzipped file is well-formed XML.
	 * The seed zip file should contain 1 well-formed xml file
	 * 
	 * @throws Exception
	 */
