/*
	 ...
	 */
package com.eurodyn.web.util.uimanage;
...
public class FSUtil {
		 ...
		 * @param path  Directory where file will be uploaded
		 * @param filename Name of file 
		 * @param InputStream Stream to be written to a file
		 */
			...
			try {
				FilenameFilter filter = new FilenameFilter() {
					public boolean accept(File dir, String name) {
						String[] suppTypes = new String[] { ".gif", ".jpg", ".png", ".jpeg", ".jp2", ".bmp", ".tiff", ".tiff-fx",
								".cgm"};
