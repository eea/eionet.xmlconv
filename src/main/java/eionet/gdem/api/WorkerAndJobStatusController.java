        ...
        if (jobId!=null) {
            try {
                ...
                if (jobEntry.getJobExecutorName()!=null) {
                    ...
                    jobExecutorService.updateJobExecutor(SchedulingConstants.WORKER_FAILED, jobId, jobEntry.getJobExecutorName(), jobExecutor.getContainerId(), jobExecutor.getHeartBeatQueue());
