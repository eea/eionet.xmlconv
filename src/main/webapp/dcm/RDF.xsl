...
<!--CR namespace  -->
        ...
        <xsl:element name="xsl:output"><xsl:attribute name="method">xml</xsl:attribute><xsl:attribute name="indent">yes</xsl:attribute></xsl:element>
...
<!--   TEMPLATE match ="Row"  -->
        <xsl:element name="xsl:template">
            <xsl:attribute name="match"><xsl:value-of select="concat('dd', parentNS, ':', identifier)"/></xsl:attribute>
            <xsl:element name="xsl:for-each"><xsl:attribute name="select"><xsl:value-of select="concat('dd', parentNS, ':Row')"/></xsl:attribute>
