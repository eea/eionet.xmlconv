...
<div id="tabbedmenu">
    <ul>
        ...
        <ed:tabItem href="/old/conversions/search" title="Search CR for XML files" id="searchXML" selectedTab="${selectedTab}">
            <spring:message code="label.conversion.tab.crconversion"/>
        </ed:tabItem>
        <ed:tabItem href="/old/conversions/excel2Xml" title="Convert spreadsheet to DD XML" id="excel2xml" selectedTab="${selectedTab}">
