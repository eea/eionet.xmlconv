 ...
 *
 * $Id: FileUpload.java,v 1.1 2004/02/13 10:14:17 te-ee Exp $
 */
...
class FileUpload{
   ...
   */
  FileUpload( String fldName ) throws GDEMException {
    if (fldName == null)
       _folderName=Utils.xslFolder; //props.getString("xsl.folder");
    else
      _folderName = fldName;
   ...
   * folder in the same computer, where servlet runs
   *
   * @param HttpRequestInputstream
   */
  File uploadFile(HttpServletRequest req) throws GDEMException {
