...
/**
 * The class acts as a adapter between XQuery engine 
 * and source file to be analyzed.
 * If QA knows the login information for source file, 
 * then it appends the information to the URL of source file parameter.
 * 
 * XQuery engine asks the file from generated URL from xmlconv 
...
public class SourceFileManager {
	...
	/**
	 * reads file from remote URL and writes it to the response stream 
	 ...
	 * @throws IOException
	 */
	public  void getFileBasicAuthentication(HttpServletResponse httpResponse, 
			String ticket, String source_url) throws IOException{
		InputFile source = new InputFile(source_url);
	 ...
	 * @throws IOException
	 */
	public  void getFileNoAuthentication(HttpServletResponse httpResponse, 
			String source_url) throws IOException{
		InputFile source = new InputFile(source_url);
		URL url = source.getURL();
	 ...
	 */
	public static String getSourceFileAdapterURL(String ticket, 
			String source_url, boolean isTrustedMode) throws MalformedURLException, IOException{
		...
		/*
		 * pass authentication information as ticket parameter
		 * and source file URl as source_url parameter
		 */
		if(!Utils.isNullStr(ticket)){
			...
			/* if we don't know the login information, 
			 then there's no sense to ask the source file throgh QA getsource adapter
