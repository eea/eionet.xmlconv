...
public abstract class XMLResultStrategy{
	...
	/**
	 * The abstract class builds XML result for servlet request
	 * Override writeElements() method for writing xml tags
	 *
	 * @throws Exception
	 */
...
//		 SAX2.0 ContentHandler.
	 ...
	 * @param tag_name		element name
	 * @param tag_value		element value
	 * @throws SAXException
	 */
