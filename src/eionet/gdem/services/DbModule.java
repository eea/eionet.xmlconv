...
public class DbModule implements DbModuleIF, Constants {
	...
	DbModule() throws GDEMException {
		...
		if (dbUrl == null || dbDriver == null || dbUser == null || dbPwd == null) throw new GDEMException("Database connection settings are not specified in gdem.properties.");
	...
	public String addQuery(String xmlSchemaID, String shortName, String queryFileName, String description, String content_type) throws SQLException {
		...
		String sql = "INSERT INTO " + QUERY_TABLE + " ( " + XSL_SCHEMA_ID_FLD + ", " + SHORT_NAME_FLD + ", " + QUERY_FILE_FLD + ", " + DESCR_FLD + ", " + RESULT_TYPE_FLD + ") VALUES ('" + xmlSchemaID + "', '" + shortName + "', " + Utils.strLiteral(queryFileName) + ", " + Utils.strLiteral(description) + ", " + Utils.strLiteral(content_type) + ")";
	...
	public String addRootElem(String xmlSchemaID, String elemName, String namespace) throws SQLException {
		...
		String sql = "INSERT INTO " + ROOTELEM_TABLE + " ( " + ELEM_SCHEMA_ID_FLD + ", " + ELEM_NAME_FLD + ", " + NAMESPACE_FLD + ") VALUES (" + Utils.strLiteral(xmlSchemaID) + ", " + Utils.strLiteral(elemName) + ", " + Utils.strLiteral(namespace) + ")";
	...
	private String[][] _executeStringQuery(String sql) throws SQLException {
		...
		if (_l.enable(_l.DEBUG)) _l.debug(sql);
	...
	public Connection getConnection() throws SQLException {
		...
		if (con == null) throw new SQLException("Failed to get database connection");
	...
	/*
	 * private static void _ll(String s ){ System.out.println("==== " + s); }
	 */
	...
	public Vector getSchemaRootElems(String schemaId) throws SQLException {
		...
		String sql = "SELECT " + ROOTELEM_ID_FLD + ", " + ELEM_NAME_FLD + ", " + NAMESPACE_FLD + "," + ELEM_SCHEMA_ID_FLD + " FROM " + ROOTELEM_TABLE + " WHERE " + ELEM_SCHEMA_ID_FLD + "=" + id;
	...
	public String startXQJob(String url, String xqFile, String resultFile, int xqID) throws SQLException {
		...
		sql = "SELECT " + JOB_ID_FLD + " FROM " + WQ_TABLE + " WHERE " + XQ_FILE_FLD + " = '" + xqFile + "' AND " + RESULT_FILE_FLD + " = '" + resultFile + "'";
	...
	public void changeFileJobsStatus(String url, String savedFile, int status) throws SQLException {
		...
		// String sql="UPDATE " + WQ_TABLE + " SET STATUS=" + status +
				", " + TIMESTAMP_FLD + "= NOW()" + " WHERE " + URL_FLD + "=" + Utils.strLiteral(url) + " AND " + STATUS_FLD + "<" + status;
		_executeUpdate(sql);
	}
	...
	private String _getLastInsertID() throws SQLException {
		...
		rs.clearWarnings();
		if (rs.next()) lastInsertId = rs.getString(1);
		_close(con, stmt, rs);
	...
	private String getXFormID(String XMLSchema) throws SQLException {
		...
		String sql = "SELECT " + FILE_ID_FLD + " FROM " + FILE_TABLE + " WHERE " + FILE_PARENTID_FLD + " = " + schema_id + " AND " + FILE_TYPE_FLD + "='" + XFORM_FILE_TYPE + "' AND" + FILE_PARENTTYPE_FLD + "='" + SCHEMA_FILE_PARENT + "'";
