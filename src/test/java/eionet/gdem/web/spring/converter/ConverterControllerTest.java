...
public class ConverterControllerTest {
    ...
    public void list() throws Exception {
        mockMvc.perform(get("/converter"))
                .andExpect(model().attribute("form", instanceOf(ConversionForm.class)));
    }

    @Test
    public void convert() throws Exception {
        String url = TestUtils.getLocalURL("xmlfile/seed-ozone-station.xml");
        mockMvc.perform(post("/converter")
                .param("convert", "")
                .param("url", url)
                .param("conversionId", "1"))
    ...
    public void find() throws Exception {
        ...
        mockMvc.perform(post("/converter")
                ...
                .andExpect(view().name("/converter/convert"));
    }
}