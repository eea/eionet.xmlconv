...
import eionet.gdem.rabbitMQ.service.HeavyJobRabbitMessageSenderImpl;
...
public class HeavyJobRabbitMessageSenderImplTest {
    ...
    @Spy
    @InjectMocks
    private HeavyJobRabbitMessageSenderImpl heavyJobRabbitMessageSender;
    ...
    public void testSendMessageToRabbitMQNullWorkerRetries() {
        heavyJobRabbitMessageSender.sendMessageToRabbitMQ(workerJobRabbitMQRequestMessage);
        verify(heavyJobRabbitMessageSender).sendMessageToRabbitMQ(workerJobRabbitMQRequestMessage);
    }
