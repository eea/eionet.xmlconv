...
<div id="tabbedmenu">
		<ul>
           ...
           href="<c:url value="/editUI/viewHeader.do"/>"><bean:message key="label.editUI.headereditor"/></a></li>
...
<p>&nbsp;</p>
<h1><bean:message key="label.editUI.footerpreview"/></h1>
<br/>
<br/>
<div style="border: thin dashed #606060; padding: 1em;width:95%;">
<ed:ui-renderer id="footer" enableJs="true"/>
</div>
<br />
<br />
