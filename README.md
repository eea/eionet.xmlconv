...
**Important Note:**
When deploying to rancher platform, any environment variables provided to tomcat container through the *CATALINA_OPTS* variable, should not include new lines for
