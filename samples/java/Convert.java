...
/**
 * Sample java code for calling ConversionService convert method Requires http-client-3.1 and commons-codec-2.1 libraries
 * 
...
public class Convert {
    ...
    public static void convert(String convert_url, String convert_id) {
        ...
        try {
            NameValuePair[] data = {new NameValuePair("url", convert_url), new NameValuePair("convert_id", convert_id)};
    ...
    public static void main(String args[]) {
        String convert_url =
                "https://svn.eionet.europa.eu/repositories/Reportnet/Dataflows/HabitatsDirectiveArticle17/xmlfiles/general-instancefile.xml";
